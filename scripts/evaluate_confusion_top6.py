...
print("Classes (top6):", class_names)
...
plt.title("Confusion Matrix â€“ Top 6 Species")
plt.colorbar()
...
out_path = MODEL_PATH.parent / "confusion_matrix_top6.png"
